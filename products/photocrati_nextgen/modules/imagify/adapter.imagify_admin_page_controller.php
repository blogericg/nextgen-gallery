...
class A_Imagify_Admin_Page_Controller extends Mixin
{
    function enqueue_backend_resources()
    {
        ...
        wp_enqueue_style(
            ...
            $this->get_static_url('photocrati-imagify#style.css'),
            array(),
            NGG_SCRIPT_VERSION
        ); 
    }
    ...
    function index_action()
    {
        ...
        if (($html = C_Photocrati_Transient_Manager::fetch($key, FALSE)))
        {
            ...
            print $this->render_view(
                'photocrati-imagify#admin_page',
                array(
                	'i18n'                  => $this->get_i18n_strings(),
	                'is_imagify_activated'  =>  Imagify_Partner::is_imagify_activated(),
					'imagify_install_url'   => $imagify_install_url,
                    'imagify_plugin_url'    => 'https://wordpress.org/plugins/imagify/',
                    'imagify_website_url'   => 'https://imagify.io/?utm_source=nextgen-gallery&utm_campaign=plugin_partner&utm_medium=partnership',
                    'imagify_review_url'    => 'https://www.imagely.com/image-optimization-plugin-comparison/'
                ),
                TRUE
            );
