...
class A_NextGen_Pro_Upgrade_Controller extends Mixin
{
    ...
    public function get_marketing_blocks()
    {
        ...
        $retval[] = new C_Marketing_Block_Card(
            __('Digital Downloads', 'nggallery'),
            __('Offer digital downloads of your images for free, or with payment using the Ecommerce system. You have complete control over sizes and pricing for every image.', 'nggallery'),
            'digital-downloads.svg',
            $medium,
            'digitaldownloads'
        );
