...
/******/ 	return __webpack_require__(__webpack_require__.s = "./products/photocrati_nextgen/modules/rest/static/debugger.jsx");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./products/photocrati_nextgen/modules/rest/static/debugger.jsx":
/*!**********************************************************************!*\
  !*** ./products/photocrati_nextgen/modules/rest/static/debugger.jsx ***!
  \**********************************************************************/
...
var LinksDisplay = /*#__PURE__*/function (_React$Component) {
  _inherits(LinksDisplay, _React$Component);

  var _super = _createSuper(LinksDisplay);

  function LinksDisplay() {
    var _this;

    _classCallCheck(this, LinksDisplay);
    ...
    _defineProperty(_assertThisInitialized(_this), "add_endpoint", function (link) {
      var url = link.replace(window.ngg_rest_debugger_url, '');

      _this.props.add_endpoint({
        endpoint: url
      });
    });
  ...
  _createClass(LinksDisplay, [{
    key: "render",
    value: function render() {
      var _this2 = this;

      return Object.keys(this.props.links).map(function (key, ndx) {
        return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_1__["Fragment"], {
          key: "link-fragment-" + ndx
        }, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("a", {
          key: "link-" + ndx,
          href: _this2.props.links[key].href,
          onClick: function onClick(event) {
            event.preventDefault();

            _this2.add_endpoint(_this2.props.links[key].href);
          }
        }, key), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("br", null));
      });
    }
  }]);
...
var TableOutput = /*#__PURE__*/function (_React$Component2) {
  _inherits(TableOutput, _React$Component2);

  var _super2 = _createSuper(TableOutput);
  ...
  _createClass(TableOutput, [{
    ...
    value: function render() {
      ...
      var headers = [];
      var rows = [];
      this.props.values.map(function (item, itemndx) {
        if (headers.length === 0) {
          headers.push(react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("tr", {
            key: "header-tr-0"
          }, Object.keys(item).map(function (key, ndx) {
            return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("th", {
              key: "header-th-" + itemndx + "-" + ndx
            }, key);
          })));
        }

        rows.push(react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("tr", {
          key: "value-tr-" + itemndx
        }, Object.values(item).map(function (key, ndx) {
          return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("td", {
            key: "value-tdx-" + itemndx + "-" + ndx
          }, 'object' === _typeof(key) ? Object.keys(item)[ndx] === '_links' ? react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(LinksDisplay, {
            add_endpoint: _this3.props.add_endpoint,
            links: key
          }) : react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("xmp", null, " ", print_formatted_array(key), " ") : key);
        })));
      });
      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("button", {
        onClick: function onClick() {
          return _this3.props.updater(_this3.props.resource_type);
        }
      }, "Debug /", this.props.resource_type.endpoint), "\xA0", react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("button", {
        onClick: function onClick() {
          return _this3.props.close(_this3.props.resource_type);
        }
      }, "Close /", this.props.resource_type.endpoint), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("table", null, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("thead", null, headers[0]), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("tbody", null, rows)), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("hr", null));
    }
  }]);
...
var NGGDebugRester = /*#__PURE__*/function (_React$Component3) {
  _inherits(NGGDebugRester, _React$Component3);

  var _super3 = _createSuper(NGGDebugRester);

  function NGGDebugRester() {
    var _this4;

    _classCallCheck(this, NGGDebugRester);
    ...
    _defineProperty(_assertThisInitialized(_this4), "resource_types", [{
      endpoint: "galleries"
    }, {
      endpoint: "albums"
    }, {
    ...
    _defineProperty(_assertThisInitialized(_this4), "fetch_update", function (resource_type) {
      var url = window.ngg_rest_debugger_url + resource_type.endpoint;
      ...
      fetch(url).then(function (response) {
        ...
        if (data instanceof Array) {
          self.setState(_defineProperty({}, resource_type.endpoint, data));
        } else {
          self.setState(_defineProperty({}, resource_type.endpoint, [data]));
        }
      });
    ...
    _defineProperty(_assertThisInitialized(_this4), "clear_endpoint", function (endpoint) {
      _this4.state[endpoint.endpoint] = [];

      _this4.setState(_this4.state);
    });

    _defineProperty(_assertThisInitialized(_this4), "add_endpoint", function (endpoint) {
      if (_this4.state[endpoint.endpoint]) return;

      _this4.resource_types.push(endpoint);
  ...
  _createClass(NGGDebugRester, [{
    key: "render",
    value: function render() {
      var _this5 = this;

      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_1__["Fragment"], null, this.resource_types.map(function (resource_type) {
        return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(TableOutput, {
          resource_type: resource_type,
          updater: _this5.fetch_update,
          add_endpoint: _this5.add_endpoint,
          key: resource_type.endpoint,
          close: _this5.clear_endpoint,
          values: _this5.state[resource_type.endpoint]
        });
      }));
    }
  }]);

  return NGGDebugRester;
}(react__WEBPACK_IMPORTED_MODULE_1___default.a.Component);

function init(node) {
  react_dom__WEBPACK_IMPORTED_MODULE_0___default.a.render(react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(NGGDebugRester, null), node);
}
